...
import com.jay.statements.domain.WishList;
import com.jay.statements.repository.WishListRepository;
...
public class WishListResourceIntTest {
    ...
    private static final String DEFAULT_NAME_OF_LIST = "AAAAAAAAAA";
    private static final String UPDATED_NAME_OF_LIST = "BBBBBBBBBB";
    ...
    public static WishList createEntity(EntityManager em) {
        WishList wishList = new WishList()
            .nameOfList(DEFAULT_NAME_OF_LIST);
        return wishList;
    }
    ...
    public void createWishList() throws Exception {
        ...
        assertThat(testWishList.getNameOfList()).isEqualTo(DEFAULT_NAME_OF_LIST);
    }
    ...
    @Test
    @Transactional
    public void checkNameOfListIsRequired() throws Exception {
        int databaseSizeBeforeTest = wishListRepository.findAll().size();
        // set the field null
        wishList.setNameOfList(null);
    ...
    public void getAllWishLists() throws Exception {
        ...
        restWishListMockMvc.perform(get("/api/wish-lists?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].nameOfList").value(hasItem(DEFAULT_NAME_OF_LIST.toString())));
    }
    ...
    public void getWishList() throws Exception {
        ...
        restWishListMockMvc.perform(get("/api/wish-lists/{id}", wishList.getId()))
            ...
            .andExpect(jsonPath("$.nameOfList").value(DEFAULT_NAME_OF_LIST.toString()));
    }
    ...
    public void updateWishList() throws Exception {
        ...
        updatedWishList
            .nameOfList(UPDATED_NAME_OF_LIST);
        ...
        WishList testWishList = wishListList.get(wishListList.size() - 1);
        assertThat(testWishList.getNameOfList()).isEqualTo(UPDATED_NAME_OF_LIST);
    }
